...
const DEMO: Product[] = [
  { id:"1", sellerId:"s1", seller: mkSeller("s1","Kariakoo Electronics","Kariakoo"), name:"Samsung Galaxy A35 5G", description:"", price:650000, compareAtPrice:750000, category:"electronics", images:["https://picsum.photos/seed/phone1/400/400"],  stock:15, tags:[], rating:4.7, reviewCount:234, sold:89,  active:true, createdAt:new Date(), updatedAt:new Date() },
  ...
  { id:"3", sellerId:"s1", seller: mkSeller("s1","Kariakoo Electronics","Kariakoo"), name:"TWS Earbuds Pro",       description:"", price:45000, compareAtPrice:65000,      category:"electronics", images:["https://picsum.photos/seed/earbuds1/400/400"], stock:8,  tags:[], rating:4.3, reviewCount:56,  sold:43,  active:true, createdAt:new Date(), updatedAt:new Date() },
  { id:"4", sellerId:"s3", seller: mkSeller("s3","Duka la Nyumbani","Kariakoo"),     name:"Sufuria Aluminium 20L", description:"", price:35000, compareAtPrice:undefined,  category:"home",        images:["https://picsum.photos/seed/pot1/400/400"],    stock:20, tags:[], rating:4.6, reviewCount:34,  sold:28,  active:true, createdAt:new Date(), updatedAt:new Date() },
  ...
  { id:"6", sellerId:"s4", seller: mkSeller("s4","Tech Kariakoo","Kariakoo"),        name:"Power Bank 20000mAh",   description:"", price:55000, compareAtPrice:75000,      category:"electronics", images:["https://picsum.photos/seed/powerbank1/400/400"],stock:25, tags:[], rating:4.5, reviewCount:178, sold:145, active:true, createdAt:new Date(), updatedAt:new Date() },
  ...
  { id:"8", sellerId:"s3", seller: mkSeller("s3","Duka la Nyumbani","Kariakoo"),     name:"Godoro la Povu 6×6",    description:"", price:180000,compareAtPrice:220000,     category:"home",        images:["https://picsum.photos/seed/mattress1/400/400"],stock:10, tags:[], rating:4.4, reviewCount:45,  sold:32,  active:true, createdAt:new Date(), updatedAt:new Date() },
];
